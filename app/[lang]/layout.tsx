...
const seoByLang: Record<string, { title: string; description: string }> = {
  es: {
    ...
    description:
      "Descarga videos de TikTok sin marca de agua gratis. Rápido, online y compatible con celular y PC.",
  },
  en: {
    title: "Download TikTok videos without watermark | Clipnexo",
    description:
      "Download TikTok videos without watermark for free. Fast, online, and compatible with mobile and PC.",
  },
  pt: {
    title: "Baixar vídeos do TikTok sem marca d’água | Clipnexo",
    description:
      "Baixe vídeos do TikTok sem marca d’água grátis. Rápido, online e compatível com celular e PC.",
  },
};
